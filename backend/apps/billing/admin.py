...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    def get_contract(self, obj):
        if obj.contract:
            return f"{obj.contract.full_name} ({obj.contract.institute or 'Private'})"
        return "-"

    get_contract.short_description = _("Contract")
    get_contract.admin_order_field = "contract__last_name"
...
class InvoiceItemAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "description",
        "invoice__payer_name",
        "lesson__contract__first_name",
        "lesson__contract__last_name",
    ]
    ...
    def get_student_name(self, obj):
        if obj.lesson and obj.lesson.contract:
            return obj.lesson.contract.full_name
        return "-"

    get_student_name.short_description = _("Student")
    get_student_name.admin_order_field = "lesson__contract__last_name"
